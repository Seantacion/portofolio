// constants/project-images.constants.ts

import type { ProjectImage } from "@/types/project.types";

export const TURELTH_IMAGES: ProjectImage[] = [
...
export const JENOS_IMAGES: ProjectImage[] = [
...
export const MOVIE_IMAGES: ProjectImage[] = [
...
export const COMPANY_PROFILE_IMAGES: ProjectImage[] = [
